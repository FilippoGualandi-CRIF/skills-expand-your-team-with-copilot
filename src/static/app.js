document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    ...
    try {
      ...
      // Handle difficulty filter on the server side if a specific difficulty is selected
      if (currentDifficulty !== "all" && currentDifficulty !== "none") {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter for "none" option (activities with no difficulty_level)
      if (currentDifficulty === "none" && details.difficulty_level) {
        return;
      }
